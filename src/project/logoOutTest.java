...
public class logoOutTest {
	...
	public static void main(String[] args) {
		...
		// System.out.println(" -osssssso :osssss- :ssss. `osss+ ");
		// System.out.println("`+sssso+/:` `+sssso/: `ossss- `ossss- ");
		// System.out.println("/ssss- +ssss- ` :sssss- `ossss. ");
		// System.out.println("ssss/ ssss/ .ssssssssssss-`ossso. ");
		// System.out.println("ossso .sssso ://+sssssssssossso` ");
		// System.out.println(".sssss/-.-:+sssssss/:-:/sssso`/sssssso` ");
		// System.out.println(" `+ssssssssssso+sssssssssss: /sssso` ");
		// System.out.println(" `:+ossso+:. `-/+ooo+/- -++/` ");
